...
Light::Light(GLFWwindow* window, 
    ...
    lightSpeed = 0.1f;
    targetPosition = glm::vec3(0.0, 5.0, 0.0);

   
    projectionMatrix = ortho(-20.0f, 20.0f, -10.0f, 10.0f, nearPlane, farPlane);
    //projectionMatrix = perspective(radians(120.0f), 1920.0f / 1000.0f, nearPlane, farPlane);
...
void Light::update() {
   ...
   // Move across z-axis
    ...
    if (glfwGetKey(window, GLFW_KEY_R) == GLFW_PRESS) {
        lightPosition_worldspace = vec3(-5, 7.85, 7);
    }
